...
selection.&]
[s0; [%-*C@4 T]-|Type of output value. Must be able to be assigned Null.&]
[s2; &]
[s0;:`:`:CallbackArgTarget`:`:CallbackArgTarget`(`):%- [* CallbackArgTarget]()&]
[s2; Constructor. Assigns Null to the output value.&]
[s2; &]
[s0;:`:`:CallbackArgTarget`:`:operator const T`&`(`):%- [* operator_const_T`&]()&]
[s7; [*/ Return value]-|The result. If no CallbackArgTarget was invoked, 
returns Null.&]
[s0; &]
[s0;:`:`:CallbackArgTarget`:`:IsNullInstance`(`)const:%- bool_[* IsNullInstance]()_cons
t&]
[s7; [*/ Return value]-|True if there is not Null in output value.&]
[s0; &]
[s0;:`:`:CallbackArgTarget`:`:operator`[`]`(const T`&`):%- Callback_[* operator`[`]](co
nst_T`&_[*@3 value])&]
