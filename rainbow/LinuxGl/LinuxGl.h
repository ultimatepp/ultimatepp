...
#define GUIPLATFORM_CTRL_DECLS_INCLUDE <LinuxGl/Ctrl.h>
#define GUIPLATFORM_PASTECLIP_DECLS \
	bool dnd; \
	friend struct DnDLoop;
#define GUIPLATFORM_TOPWINDOW_DECLS_INCLUDE <LinuxGl/Top.h>
