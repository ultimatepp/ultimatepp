...
[s0; Ð˜ÑÑ‚Ð¾Ñ€Ð¸Ñ‡ÐµÑÐºÐ¸ Ð¿Ð¾Ñ‡Ñ‚Ð¸ ÐºÐ°Ð¶Ð´Ñ‹Ð¹ ÑÐ·Ñ‹Ðº Ð¸Ð»Ð¸ 
ÑÑ€ÐµÐ´Ð° Ð¿Ñ€Ð¾Ð³Ñ€Ð°Ð¼Ð¼Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ñ Ð¸Ð¼ÐµÑŽÑ‚ Ñ€Ð°Ð·Ð»Ð¸Ñ‡Ð½Ð¾Ð³Ð¾ 
Ð²Ð¸Ð´Ð° Ð¿Ñ€Ð¸Ð¼ÐµÑ€Ñ‹ Ñ‚Ð¸Ð¿Ð° `"Hello world!`", Ð¸ Ultimate`+`+ 
Ð½Ðµ ÑÐ²Ð»ÑÐµÑ‚ÑÑ Ð¸ÑÐºÐ»ÑŽÑ‡ÐµÐ½Ð¸ÐµÐ¼ :). Ð’ ÑÑ‚Ð¾Ð¼ ÐºÐ¾Ñ€Ð¾Ñ‚ÐºÐ¾Ð¼ 
ÑƒÑ€Ð¾ÐºÐµ Ñ Ð¿Ð¾ÑÑ‚Ð°Ñ€Ð°ÑŽÑÑŒ Ð¾Ð±ÑŠÑÑÐ½Ð¸Ñ‚ÑŒ Ð’Ð°Ð¼ 
Ð¾ÑÐ½Ð¾Ð²Ñ‹ U`+`+ Ð¿Ñ€Ð¸Ð»Ð¾Ð¶ÐµÐ½Ð¸Ñ Ñ Ð¿Ð¾Ð¼Ð¾Ñ‰ÑŒÑŽ HelloWorld 
U`+`+ Ð¿Ñ€Ð¸Ð¼ÐµÑ€Ð°.&]
[s0; ÐšÐ¾Ð³Ð´Ð° Ð²Ñ‹ Ð·Ð°Ð¿ÑƒÑÑ‚Ð¸Ñ‚Ðµ Ð¿Ñ€Ð¸Ð»Ð¾Ð¶ÐµÐ½Ð¸Ðµ HelloWorld 
Ð¸ Ð²Ñ‹Ð±ÐµÑ€ÐµÑ‚Ðµ Ð¿ÑƒÐ½ÐºÑ‚ Ð¼ÐµÐ½ÑŽ `"File`->About`" Ð²Ñ‹ 
ÑƒÐ²Ð¸Ð´Ð¸Ñ‚Ðµ Ñ‡Ñ‚Ð¾`-Ñ‚Ð¾ Ð²Ñ€Ð¾Ð´Ðµ ÑÑ‚Ð¾Ð³Ð¾:&]
[s0; &]
[s0;= 
@@image:2162&1572
...
&]
[s0; &]
[s0; Ð”Ð°Ð²Ð°Ð¹Ñ‚Ðµ Ð¸Ð·ÑƒÑ‡Ð¸Ð¼ Ð¸ÑÑ…Ð¾Ð´Ð½Ñ‹Ð¹ ÐºÐ¾Ð´ HelloWorld 
U`+`+ Ð¿Ñ€Ð¸Ð»Ð¾Ð¶ÐµÐ½Ð¸Ñ:&]
[s0; &]
...
[s7; `}&]
[s0;3 &]
[s0; ÐœÐ½Ð¾Ð³Ð¾ ÐµÑ‰Ðµ Ð½ÐµÐ¸Ð·Ð²ÐµÑÑ‚Ð½Ñ‹Ñ… Ð’Ð°Ð¼ Ð¸Ð½ÑÑ‚Ñ€ÑƒÐ¼ÐµÐ½Ñ‚Ð¾Ð², 
Ð½Ð¾ Ð´Ð°Ð²Ð°Ð¹Ñ‚Ðµ Ð½Ðµ Ð±ÑƒÐ´ÐµÐ¼ Ñ‚Ð¾Ñ€Ð¾Ð¿Ð¸Ñ‚ÑŒÑÑ, Ñ€Ð°Ð·Ð±ÐµÑ€ÐµÐ¼ 
ÐºÐ¾Ð´ Ð¿Ð¾ÑÑ‚Ñ€Ð¾Ñ‡Ð½Ð¾.&]
[s0; &]
[s0; Ð’ Ð¿ÐµÑ€Ð²ÑƒÑŽ Ð¾Ñ‡ÐµÑ€ÐµÐ´ÑŒ, Ð¼Ñ‹ Ð¿Ð¾Ð´ÐºÐ»ÑŽÑ‡Ð°ÐµÐ¼ `"CtrlLib/CtrlLib.h`";
 ÑÑ‚Ð¾Ñ‚ Ð·Ð°Ð³Ð¾Ð»Ð¾Ð²Ð¾Ðº Ð²ÐºÐ»ÑŽÑ‡Ð°ÐµÑ‚ Ð² ÑÐµÐ±Ñ Ð±Ð¾Ð»ÑŒÑˆÑƒÑŽ 
Ñ‡Ð°ÑÑ‚ÑŒ U`+`+ Ð²Ð¸Ð´Ð¶ÐµÑ‚Ð¾Ð². Ð’ÑÐµ U`+`+ Ð²Ð¸Ð´Ð¶ÐµÑ‚Ñ‹ 
Ð¿Ð¾Ñ€Ð¾Ð¶Ð´ÐµÐ½Ñ‹ Ð¾Ñ‚ Ð±Ð°Ð·Ð¾Ð²Ð¾Ð³Ð¾ ÐºÐ»Ð°ÑÑÐ° [^topic`:`/`/CtrlCore`/src`/Ctrl`$en`-us`#`:`:Ctrl`:`:class^ C
trl], Ð¿Ð¾ÑÑ‚Ð¾Ð¼Ñƒ Ð¸Ñ… Ñ‚Ð°ÐºÐ¶Ðµ Ð½Ð°Ð·Ñ‹Ð²Ð°ÑŽÑ‚ `"Ctrls`" 
(ÐºÐ¾Ð½Ñ‚Ñ€Ð¾Ð»Ñ‹).&]
[s0; &]
[s0; Ð¡Ð»ÐµÐ´ÑƒÑŽÑ‰Ð¸Ð¹ ÑˆÐ°Ð³ `- Ð½Ð°ÑÐ»ÐµÐ´ÑƒÐµÐ¼ HelloWorld Ð¾Ñ‚ 
ÐºÐ»Ð°ÑÑÐ° [^topic`:`/`/CtrlCore`/src`/TopWindow`$en`-us`#`:`:TopWindow`:`:class^ T
opWindow], ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ð¹ Ð¿Ñ€ÐµÐ´ÑÑ‚Ð°Ð²Ð»ÑÐµÑ‚ Ð¸Ð· ÑÐµÐ±Ñ 
Ð±Ð°Ð·Ð¾Ð²Ð¾Ðµ Ð¾ÐºÐ½Ð¾, Ð¸Ð½Ñ‚ÐµÑ€Ñ„ÐµÐ¹Ñ Ñ€Ð°Ð±Ð¾Ñ‚Ñ‹ Ñ ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ð¼ 
Ð½Ðµ Ð·Ð°Ð²Ð¸ÑÐ¸Ñ‚ Ð¾Ñ‚ Ð¾ÑÐ¾Ð±ÐµÐ½Ð½Ð¾ÑÑ‚ÐµÐ¹ Ð¾Ð¿ÐµÑ€Ð°Ñ†Ð¸Ð¾Ð½Ð½Ð¾Ð¹ 
ÑÐ¸ÑÑ‚ÐµÐ¼Ñ‹. ÐšÐ»Ð°ÑÑ ÑÐ¾Ð´ÐµÑ€Ð¶Ð¸Ñ‚ Ð¼Ð½Ð¾Ð¶ÐµÑÑ‚Ð²Ð¾ 
Ð¸Ð½ÑÑ‚Ñ€ÑƒÐ¼ÐµÐ½Ñ‚Ð¾Ð², Ñ‚Ð°ÐºÐ¸Ñ… ÐºÐ°Ðº, Ð½Ð°Ð¿Ñ€Ð¸Ð¼ÐµÑ€, 
Ð·Ð°Ð³Ð¾Ð»Ð¾Ð²Ð¾Ðº, ÐºÐ½Ð¾Ð¿ÐºÐ¸ Ð·Ð°ÐºÑ€Ñ‹Ñ‚Ð¸Ñ/ÑÐ²ÐµÑ€Ñ‚Ñ‹Ð²Ð°Ð½Ð¸Ñ 
Ð¾ÐºÐ½Ð° Ð¸ Ñ‚. Ð¿. Ð˜Ð½Ð°Ñ‡Ðµ Ð³Ð¾Ð²Ð¾Ñ€Ñ, ÑÑ‚Ð¾ Ð½Ð°ÑˆÐµ 
ÑÑ‚Ð°Ð½Ð´Ð°Ñ€Ñ‚Ð½Ð¾Ðµ Ð¾ÐºÐ½Ð¾, ;).&]
[s0; &]
[s0; ÐžÐºÐ½Ð¾ HelloWorld Ð¸Ð¼ÐµÐµÑ‚ Ð³Ð»Ð°Ð²Ð½Ð¾Ðµ Ð¼ÐµÐ½ÑŽ Ð¸ ÑÑ‚Ñ€Ð¾ÐºÑƒ 
ÑÑ‚Ð°Ñ‚ÑƒÑÐ°, ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ðµ Ð² ÐºÐ»Ð°ÑÑÐµ Ð¾Ð¿Ð¸ÑÐ°Ð½Ñ‹ 
ÐºÐ°Ðº Ð´Ð²Ð° private Ñ‡Ð»ÐµÐ½Ð°.&]
[s0; &]
[s7; MenuBar menu;&]
[s7; StatusBar status; &]
[s7; &]
[s0; &]
[s0; Ð’ ÐºÐ¾Ð½ÑÑ‚Ñ€ÑƒÐºÑ‚Ð¾Ñ€Ðµ HelloWorld Ñ Ð¿Ð¾Ð¼Ð¾Ñ‰ÑŒÑŽ [^topic`:`/`/CtrlCore`/src`/Ctrl`$en`-us`#`:`:Ctrl`:`:AddFrame`(`:`:CtrlFrame`&`)^ A
ddFrame] Ñ„ÑƒÐ½ÐºÑ†Ð¸Ð¸ Ð´Ð¾Ð±Ð°Ð²Ð»ÐµÐ½Ñ‹ Ð³Ð»Ð°Ð²Ð½Ð¾Ðµ Ð¼ÐµÐ½ÑŽ 
Ð¸ ÑÑ‚Ñ€Ð¾ÐºÐ° ÑÑ‚Ð°Ñ‚ÑƒÑÐ°. AddFrame Ð´Ð¾Ð±Ð°Ð²Ð»ÑÐµÑ‚ Ð´Ð°Ð½Ð½Ñ‹Ðµ 
ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚Ñ‹ ÐºÐ°Ðº [^topic`:`/`/CtrlCore`/srcdoc`/AboutFrames`$en`-us^ Frames] 
(Ñ€Ð°Ð¼ÐºÐ¸), Ð¿Ð¾Ð¼ÐµÑ‰Ð°Ñ Ð¸Ñ… Ð½Ð° Ð³Ñ€Ð°Ð½Ð¸Ñ†Ñƒ Ð¾ÐºÐ½Ð° 
Ð¸ ÑƒÐ¼ÐµÐ½ÑŒÑˆÐ°Ñ Ð²Ð¸Ð´Ð¸Ð¼ÑƒÑŽ Ð¾Ð±Ð»Ð°ÑÑ‚ÑŒ Ð¾ÐºÐ½Ð°. Ð˜ 
Ð³Ð»Ð°Ð²Ð½Ð¾Ðµ Ð¼ÐµÐ½ÑŽ, Ð¸ ÑÑ‚Ñ€Ð¾ÐºÐ° ÑÑ‚Ð°Ñ‚ÑƒÑÐ° Ð·Ð½Ð°ÑŽÑ‚ 
Ð³Ð´Ðµ Ð´Ð¾Ð»Ð¶Ð½Ð¾ Ð±Ñ‹Ñ‚ÑŒ Ð¼ÐµÑÑ‚Ð¾ Ð¸Ñ… Ñ€Ð°Ð·Ð¼ÐµÑ‰ÐµÐ½Ð¸Ñ, 
ÐºÐ¾Ð³Ð´Ð° Ð¾Ð½Ð¸ Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÑŽÑ‚ÑÑ Ð² ÐºÐ°Ñ‡ÐµÑÑ‚Ð²Ðµ 
Ñ€Ð°Ð¼Ð¾Ðº (Ð³Ð»Ð°Ð²Ð½Ð¾Ðµ Ð¼ÐµÐ½ÑŽ Ð²Ð²ÐµÑ€Ñ…Ñƒ, ÑÑ‚Ñ€Ð¾ÐºÐ° 
ÑÑ‚Ð°Ñ‚ÑƒÑÐ° Ð²Ð½Ð¸Ð·Ñƒ).&]
[s0; &]
[s0; Ð¡Ð»ÐµÐ´ÑƒÑŽÑ‰Ð°Ñ ÑÑ‚Ñ€Ð¾ÐºÐ° Ð² ÐºÐ¾Ð½ÑÑ‚Ñ€ÑƒÐºÑ‚Ð¾Ñ€Ðµ 
Ð¾Ñ‡ÐµÐ½ÑŒ Ð¸Ð½Ñ‚ÐµÑ€ÐµÑÐ½Ð°:&]
[s0; &]
[s7; menu.Add(`"File`", THISBACK(FileMenu));&]
[s0; &]
[s0; Ð¸ Ð·Ð°ÑÐ»ÑƒÐ¶Ð¸Ð²Ð°ÐµÑ‚ Ð±Ð¾Ð»ÐµÐµ Ð¿Ð¾Ð´Ñ€Ð¾Ð±Ð½Ð¾Ð³Ð¾ Ð¾Ð±ÑŠÑÑÐ½ÐµÐ½Ð¸Ñ. 
U`+`+ Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÐµÑ‚ [^topic`:`/`/Core`/src`/Callbacks`$en`-us^ callbacks] 
`- callbacks Ð¼Ð¾Ð³ÑƒÑ‚ Ð±Ñ‹Ñ‚ÑŒ Ð¾Ð¿Ð¸ÑÐ°Ð½Ñ‹ ÐºÐ°Ðº Ð²ÐµÑÑŒÐ¼Ð° 
Ð¾Ð±Ð¾Ð±Ñ‰ÐµÐ½Ð½Ð°Ñ Ñ„Ð¾Ñ€Ð¼Ð° ÑƒÐºÐ°Ð·Ð°Ñ‚ÐµÐ»ÐµÐ¹ Ð½Ð° Ñ„ÑƒÐ½ÐºÑ†Ð¸Ð¸. 
ÐšÐ°Ð¶Ð´Ñ‹Ð¹ Callback Ð¿Ñ€ÐµÐ´ÑÑ‚Ð°Ð²Ð»ÑÐµÑ‚ Ð¸Ð· ÑÐµÐ±Ñ 
Ð½ÐµÐºÐ¾Ñ‚Ð¾Ñ€Ð¾Ðµ Ð´ÐµÐ¹ÑÑ‚Ð²Ð¸Ðµ (Ð¾Ð±Ñ‹Ñ‡Ð½Ð¾ Ð²Ñ‹Ð·Ð¾Ð² 
Ð½ÐµÐºÐ¾Ñ‚Ð¾Ñ€Ð¾Ð¹ Ð¾Ð¿Ñ€ÐµÐ´ÐµÐ»ÐµÐ½Ð½Ð¾Ð¹ Ñ„ÑƒÐ½ÐºÑ†Ð¸Ð¸ Ð¸Ð»Ð¸ 
Ð¶Ðµ Ð¼ÐµÑ‚Ð¾Ð´Ð° ÐºÐ»Ð°ÑÑÐ°), ÐºÐ¾Ñ‚Ð¾Ñ€Ð¾Ðµ Ð¼Ð¾Ð¶ÐµÑ‚ Ð±Ñ‹Ñ‚ÑŒ 
Ð²Ñ‹Ð·Ð²Ð°Ð½Ð¾ Ð² Ð»ÑŽÐ±Ð¾Ð¹ Ð¼Ð¾Ð¼ÐµÐ½Ñ‚. Ð¡ÐµÐ¹Ñ‡Ð°Ñ, &]
[s0; &]
[s7; THISBACK(x)&]
[s0; &]
[s0;  ÑÑ‚Ð¾ Ð¼Ð°ÐºÑ€Ð¾Ñ, ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ð¹ Ñ€Ð°Ð·Ð²Ð¾Ñ€Ð°Ñ‡Ð¸Ð²Ð°ÐµÑ‚ÑÑ 
Ð²&]
[s0; &]
[s7; callback(this, `&CLASSNAME`::[@3 x][@0 )]&]
[s0;*C@3 &]
[s0; Ð³Ð´Ðµ x `- ÑÑ‚Ð¾ Ð½Ð°Ð·Ð²Ð°Ð½Ð¸Ðµ Ð¼ÐµÑ‚Ð¾Ð´Ð°, ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ð¹ 
Ð¼Ñ‹ Ñ…Ð¾Ñ‚Ð¸Ð¼ Ð²Ñ‹Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ ÑÑ‚Ð¸Ð¼ Ð´ÐµÐ¹ÑÑ‚Ð²Ð¸ÐµÐ¼. 
Ð¤ÑƒÐ½ÐºÑ†Ð¸Ñ [^topic`:`/`/Core`/src`/Callbacks`$en`-us`#`:`:callback`(OBJECT`*`,void`(METHOD`:`:`*`)`(P1 p1`)`)^ c
allback] `- ÑˆÐ°Ð±Ð»Ð¾Ð½Ð½Ð°Ñ Ñ„ÑƒÐ½ÐºÑ†Ð¸Ñ, Ð´Ð»Ñ ÐµÐµ Ñ€Ð°Ð±Ð¾Ñ‚Ñ‹ 
Ð½ÐµÐ¾Ð±Ñ…Ð¾Ð´Ð¸Ð¼Ð¾ Ð¾Ð¿Ñ€ÐµÐ´ÐµÐ»Ð¸Ñ‚ÑŒ Ð¿ÐµÑ€ÐµÐ¼ÐµÐ½Ð½ÑƒÑŽ 
CLASSNAME. ÐšÐ°Ð¶Ð´Ñ‹Ð¹ U`+`+ ÐºÐ»Ð°ÑÑ, ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ð¹ Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÐµÑ‚ 
[^topic`:`/`/Core`/src`/Callbacks`$en`-us`#`:`:THISBACK`(x`)^ THISBACK] 
Ð¼Ð°ÐºÑ€Ð¾Ñ ÑÐ¾Ð´ÐµÑ€Ð¶Ð¸Ñ‚ ÑÐ»ÐµÐ´ÑƒÑŽÑ‰ÑƒÑŽ ÑÑ‚Ñ€Ð¾ÐºÑƒ&]
[s0; &]
[s7; typedef HelloWorld CLASSNAME;&]
[s0;3 &]
[s0;3 &]
...
[s7; menu.Add(`"File`", THISBACK(FileMenu));&]
[s0; &]
[s0; Ð´Ð¾Ð±Ð°Ð²Ð»ÑÐµÑ‚ Ð¼ÐµÐ½ÑŽ `"File`" Ð² Ð³Ð»Ð°Ð²Ð½Ð¾Ðµ Ð¼ÐµÐ½ÑŽ 
Ð½Ð°ÑˆÐµÐ³Ð¾ Ð¿Ñ€Ð¸Ð»Ð¾Ð¶ÐµÐ½Ð¸Ñ Ð¸, ÐºÐ¾Ð³Ð´Ð° Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»ÑŒ 
Ð²Ñ‹Ð±ÐµÑ€ÐµÑ‚ ÑÑ‚Ð¾ Ð¼ÐµÐ½ÑŽ, U`+`+ Ð²Ñ‹Ð·Ð¾Ð²ÐµÑ‚ ÑÐ¾Ð¾Ñ‚Ð²ÐµÑ‚ÑÑ‚Ð²ÑƒÑŽÑ‰Ñƒ
ÑŽ Ñ„ÑƒÐ½ÐºÑ†Ð¸ÑŽ Ð¸Ð· Ð½Ð°ÑˆÐµÐ³Ð¾ HelloWorld&]
[s0;3 &]
[s7; void HelloWorld`::FileMenu(Bar`& bar)&]
[s7; `{&]
[s7; -|bar.Add(`"About..`", THISBACK(About));&]
...
[s7; `}&]
[s0;3 &]
[s0; Ð§Ñ‚Ð¾ Ð¿Ñ€Ð¾Ð¸Ð·Ð¾Ð¹Ð´ÐµÑ‚ Ñ‚ÐµÐ¿ÐµÑ€ÑŒ: Ð¿Ð¾ÑÐ»Ðµ Ð²Ñ‹Ð±Ð¾Ñ€Ð° 
`"File`" Ð¼ÐµÐ½ÑŽ Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»ÐµÐ¼, U`+`+ ÑÐ¾Ð·Ð´Ð°ÐµÑ‚ 
Ñ€Ð°ÑÐºÑ€Ñ‹Ð²Ð°ÑŽÑ‰ÐµÐµÑÑ Ð¼ÐµÐ½ÑŽ Ð¸ Ð·Ð°Ñ‚ÐµÐ¼ Ð²Ñ‹Ð·Ñ‹Ð²Ð°ÐµÑ‚ 
FileMenu Ñ„ÑƒÐ½ÐºÑ†Ð¸ÑŽ, Ð¿Ð°Ñ€Ð°Ð¼ÐµÑ‚Ñ€Ð¾Ð¼ ÐºÐ¾Ñ‚Ð¾Ñ€Ð¾Ð¹ 
ÑÐ²Ð»ÑÐµÑ‚ÑÑ Ð°Ð´Ñ€ÐµÑ Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ñ‡Ñ‚Ð¾ ÑÐ¾Ð·Ð´Ð°Ð½Ð½Ð¾Ð³Ð¾ 
Ð³Ð»Ð°Ð²Ð½Ð¾Ð³Ð¾ Ð¼ÐµÐ½ÑŽ. ÐŸÐ¾ÑÐ»Ðµ ÑÑ‚Ð¾Ð³Ð¾ FileMenu Ð´Ð¾Ð±Ð°Ð²Ð»ÑÐµÑ‚ 
`"About`" Ð¸ `"Exit`" Ð² Ð¼ÐµÐ½ÑŽ, Ñ Ñ€Ð°Ð·Ð´ÐµÐ»Ð¸Ñ‚ÐµÐ»ÐµÐ¼ 
Ð¼ÐµÐ¶Ð´Ñƒ Ð½Ð¸Ð¼Ð¸ (Separator), Ð¸ Ð½Ð°Ð·Ð½Ð°Ñ‡Ð°ÐµÑ‚ Ð¿ÑƒÐ½ÐºÑ‚Ð°Ð¼ 
Ð²Ñ‹Ð·Ð¾Ð²Ñ‹ Ñ„ÑƒÐ½ÐºÑ†Ð¸Ð¹ Ð¸Ð· Ð½Ð°ÑˆÐµÐ³Ð¾ HelloWorld Ð¾Ð±ÑŠÐµÐºÑ‚Ð° 
(Ð±Ð¾Ð»ÐµÐµ Ð´ÐµÑ‚Ð°Ð»ÑŒÐ½Ð¾Ðµ Ð¾Ð±ÑÑƒÐ¶Ð´ÐµÐ½Ð¸Ðµ ÑƒÐºÐ°Ð·Ð°Ñ‚ÐµÐ»ÐµÐ¹ 
Ð½Ð° Ñ„ÑƒÐ½ÐºÑ†Ð¸Ð¸ [^topic`:`/`/CtrlLib`/srcdoc`/MenuCb`$en`-us^ Ð·Ð´ÐµÑÑŒ]).&]
[s0;@5;3 &]
[s0; ÐŸÐ¾ÑÐ»ÐµÐ´Ð½ÑÑ ÑÑ‚Ñ€Ð¾ÐºÐ° ÐºÐ¾Ð½ÑÑ‚Ñ€ÑƒÐºÑ‚Ð¾Ñ€Ð°&]
[s0;3 &]
[s7; status `= `"Welcome to the Ultimate`+`+ !`";&]
[s0; &]
[s0; ÐšÐ»Ð°ÑÑ StatusBar Ð¸Ð¼ÐµÐµÑ‚ Ð¿ÐµÑ€ÐµÐ³Ñ€ÑƒÐ¶ÐµÐ½Ð½Ñ‹Ð¹ Ð¾Ð¿ÐµÑ€Ð°Ñ‚Ð¾Ñ€ 
`=, ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ð¹ ÑƒÑÑ‚Ð°Ð½Ð°Ð²Ð»Ð¸Ð²Ð°ÐµÑ‚ Ñ‚ÐµÐºÑÑ‚ Ð½Ð°ÑˆÐµÐ¹ 
ÑÑ‚Ñ€Ð¾ÐºÐ¸ ÑÑ‚Ð°Ñ‚ÑƒÑÐ°. ÐšÑ€Ð°ÑÐ¸Ð²Ð¾ Ð¸ Ñ‡Ð¸ÑÑ‚Ð¾.&]
[s0; &]
[s0; ÐŸÐ¾ÑÐ»ÐµÐ´Ð½ÑÑ Ñ„ÑƒÐ½ÐºÑ†Ð¸Ñ HelloWorld ÐºÐ»Ð°ÑÑÐ°&]
[s0;3 &]
[s7; void HelloWorld`::About()&]
[s7; `{&]
[s7; -|PromptOK(`"`{`{1`@5 `[`@9`= This is the`]`::`@2 `[A5`@0 Ultimate```+```+ 
...
[s7; `}&]
[s0;3 &]
[s0; ÐžÑ‡ÐµÐ²Ð¸Ð´Ð½Ð¾, ÐºÐ¾Ð³Ð´Ð° Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»ÑŒ ÐºÐ»Ð¸ÐºÐ°ÐµÑ‚ 
Ð¿Ð¾ `"File`"`->`"About`" Ð² Ð¼ÐµÐ½ÑŽ Ð²Ñ‹Ð·Ñ‹Ð²Ð°ÐµÑ‚ÑÑ Ð¸Ð¼ÐµÐ½Ð½Ð¾ 
ÑÑ‚Ð° Ñ„ÑƒÐ½ÐºÑ†Ð¸Ñ. PromtOK `- ÑƒÐ´Ð¾Ð±Ð½Ð°Ñ Ð³Ð»Ð¾Ð±Ð°Ð»ÑŒÐ½Ð°Ñ 
Ñ„ÑƒÐ½ÐºÑ†Ð¸Ñ, Ð¾Ð¿Ð¸ÑÐ°Ð½Ð½Ð°Ñ Ð² `"CtrlLib`\RichText.h`", 
Ð¾Ñ‚Ð¾Ð±Ñ€Ð°Ð¶Ð°ÐµÑ‚ Ð¿Ñ€Ð¾ÑÑ‚Ð¾Ð¹ Ð´Ð¸Ð°Ð»Ð¾Ð³ ÑÐ¾ Ð·Ð½Ð°Ñ‡ÐºÐ¾Ð¼ 
Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ð¸ Ð¸ ÐºÐ½Ð¾Ð¿ÐºÐ¾Ð¹ OK. Ð¢Ð°ÐºÐ¶Ðµ, ÑÑ‚Ð¾Ñ‚ 
Ð´Ð¸Ð°Ð»Ð¾Ð³ ÑÐ¾Ð´ÐµÑ€Ð¶Ð¸Ñ‚ Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ð¾Ð½Ð½Ð¾Ðµ ÑÐ¾Ð¾Ð±Ñ‰ÐµÐ½Ð¸Ðµ 
Ð´Ð»Ñ Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»Ñ, Ð¸ ÑÑ‚Ð¾Ñ‚ Ñ‚ÐµÐºÑÑ‚ ÑÐ²Ð»ÑÐµÑ‚ÑÑ 
Ð¿Ð°Ñ€Ð°Ð¼ÐµÑ‚Ñ€Ð¾Ð¼ PromtOK Ñ„ÑƒÐ½ÐºÑ†Ð¸Ð¸. ÐšÐ°Ðº Ð²Ñ‹ Ð·Ð°Ð¼ÐµÑ‚Ð¸Ð»Ð¸, 
ÐµÑÑ‚ÑŒ ÑÑ‚Ñ€Ð°Ð½Ð½Ñ‹Ðµ ÑÐ¸Ð¼Ð²Ð¾Ð»Ñ‹ Ð² Ð½Ð°ÑˆÐµÐ¼ Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ð¾Ð½Ð½Ð¾
Ð¼ ÑÐ¾Ð¾Ð±Ñ‰ÐµÐ½Ð¸Ð¸, ÑÑ‚Ð¾ [^topic`:`/`/RichText`/srcdoc`/QTF`$en`-us^ QTF 
ÐºÐ¾Ð´Ñ‹] (QTF `- Ñ€Ð¾Ð´Ð½Ð¾Ð¹ Ñ„Ð¾Ñ€Ð¼Ð°Ñ‚ U`+`+ Ñ„Ð¾Ñ€Ð¼Ð°Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð½Ñ‹Ñ… 
Ñ‚ÐµÐºÑÑ‚Ð¾Ð²).&]
[s0; &]
[s0; Ð˜ Ð² ÐºÐ¾Ð½Ñ†Ðµ Ð¼Ñ‹ Ð¸Ð¼ÐµÐµÐ¼ &]
[s0; &]
[s7; GUI`_APP`_MAIN&]
[s7; `{&]
[s7; -|SetLanguage(LNG`_ENGLISH);&]
...
[s7; `}&]
[s0; &]
[s0; ÐšÐ°Ðº Ð²Ñ‹ Ð´Ð¾Ð³Ð°Ð´Ñ‹Ð²Ð°ÐµÑ‚ÐµÑÑŒ, ÐºÐ°Ð¶Ð´Ð°Ñ Ð¿Ñ€Ð¾Ð³Ñ€Ð°Ð¼Ð¼Ð° 
Ð´Ð¾Ð»Ð¶Ð½Ð° Ð¸Ð¼ÐµÑ‚ÑŒ Ñ‚Ð¾Ñ‡ÐºÑƒ Ð²Ñ…Ð¾Ð´Ð°, Ð³Ð´Ðµ Ð½Ð°Ñ‡Ð¸Ð½Ð°ÐµÑ‚ÑÑ 
ÐµÐµ Ð²Ñ‹Ð¿Ð¾Ð»Ð½ÐµÐ½Ð¸Ðµ. U`+`+ ÐºÐ¾Ð´ Ð½Ð°Ñ‡Ð¸Ð½Ð°ÐµÑ‚ÑÑ 
Ñ Ð¼Ð°ÐºÑ€Ð¾ÑÐ° GUI`_APP`_MAIN. Ð­Ñ‚Ð¾Ñ‚ Ð¼Ð°ÐºÑ€Ð¾Ñ Ð¸Ð½Ð¸Ñ†Ð¸Ð°Ð»Ð¸Ð·Ð¸Ñ€ÑƒÐµ
Ñ‚ U`+`+ GUI Ð¿Ñ€Ð¸Ð»Ð¾Ð¶ÐµÐ½Ð¸Ðµ Ð´Ð»Ñ ÑÐ¾Ð¾Ñ‚Ð²ÐµÑ‚ÑÑ‚Ð²ÑƒÑŽÑ‰ÐµÐ¹ 
ÐžÐ¡ Ð¿Ð»Ð°Ñ‚Ñ„Ð¾Ñ€Ð¼Ñ‹, Ð° Ñ‚Ð°ÐºÐ¶Ðµ Ð·Ð°Ð²ÐµÑ€ÑˆÐ°ÐµÑ‚ Ñ€Ð°Ð±Ð¾Ñ‚Ñƒ 
U`+`+ ÑÑ€ÐµÐ´Ñ‹.&]
[s0; ÐšÐ°Ð¶Ð´Ð°Ñ Ñ…Ð¾Ñ€Ð¾ÑˆÐ°Ñ ÑÑ€ÐµÐ´Ð° Ñ€Ð°Ð·Ñ€Ð°Ð±Ð¾Ñ‚ÐºÐ¸ 
U`+`+ Ð¸Ð¼ÐµÐµÑ‚ Ñ…Ð¾Ñ€Ð¾ÑˆÑƒÑŽ [^topic`:`/`/Core`/srcdoc`/i18n`$en`-us^ Ð¿Ð¾Ð´Ð´Ðµ
Ñ€Ð¶ÐºÑƒ] Ð¼ÑƒÐ»ÑŒÑ‚Ð¸ÑÐ·Ñ‹Ñ‡Ð½Ñ‹Ñ… Ð¿Ñ€Ð¾Ð³Ñ€Ð°Ð¼Ð¼, Ð½Ð¾ Ð´Ð»Ñ 
Ð¿Ñ€Ð¸Ð¼ÐµÑ€Ð° Ð¾ÑÐ½Ð¾Ð²Ð½Ñ‹Ð¼ ÑÐ·Ñ‹ÐºÐ¾Ð¼ Ð¼Ñ‹ ÑƒÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ð»Ð¸ 
ÐÐ½Ð³Ð»Ð¸Ð¹ÑÐºÐ¸Ð¹.&]
[s0; Ð”Ð°Ð»ÐµÐµ Ð¼Ñ‹ ÑÐ¾Ð·Ð´Ð°ÐµÐ¼ Ð¾Ð´Ð¸Ð½ ÑÐºÐ·ÐµÐ¼Ð¿Ð»ÑÑ€ (Ð¾Ð±ÑŠÐµÐºÑ‚) 
ÐºÐ»Ð°ÑÑÐ° HelloWorld Ð¸ Ð²Ñ‹Ð·Ñ‹Ð²Ð°ÐµÐ¼ [^topic`:`/`/CtrlCore`/src`/TopWindow`$en`-us`#`:`:TopWindow`:`:Run`(bool`)^ R
un] Ñ„ÑƒÐ½ÐºÑ†Ð¸ÑŽ, Ð¾Ð¿Ñ€ÐµÐ´ÐµÐ»ÐµÐ½Ð½ÑƒÑŽ Ð² TopWindow ÐºÐ»Ð°ÑÑÐµ, 
ÐºÐ¾Ñ‚Ð¾Ñ€Ð°Ñ Ð·Ð°Ð¿ÑƒÑÑ‚Ð¸Ñ‚ Ð½Ð°ÑˆÐµ Ð¿Ñ€Ð¸Ð»Ð¾Ð¶ÐµÐ½Ð¸Ðµ[@5 .]&]
[s0;3 &]
[s0; ]