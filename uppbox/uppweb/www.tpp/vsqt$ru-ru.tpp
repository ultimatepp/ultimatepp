...
[{_}%RU-RU 
[s0;= [7 Ultimate`+`+ Ð¿Ñ€Ð¾Ñ‚Ð¸Ð² Qt ][5 (R)]&]
[s0;>%% [*R^topic`:`/`/uppweb`/www`/vsqt`$en`-us^1 `[en`]][*R1  ][*R^topic`:`/`/uppweb`/www`/vsqt`$ru`-ru^1 `[
ru`]]&]
[s0;=*R^topic`:`/`/uppweb`/www`/vsqt`$ru`-ru^1%% &]
[s0; [2 Ð”Ð»Ñ ÑÑ€Ð°Ð²Ð½ÐµÐ½Ð¸Ñ Ultimate`+`+ Ñ Qt (R), Ð¼Ñ‹ Ñ€ÐµÑˆÐ¸Ð»Ð¸ 
Ð²Ð¾ÑÐ¿Ñ€Ð¾Ð¸Ð·Ð²ÐµÑÑ‚Ð¸ Ð´ÐµÐ¼Ð¾Ð½ÑÑ‚Ñ€Ð°Ñ†Ð¸Ð¾Ð½Ð½Ñ‹Ð¹ Ð¿Ñ€Ð¸Ð¼ÐµÑ€ 
Qt `"AddressBook`". Ð¡Ð»ÐµÐ²Ð° Ñ‚Ð°Ð±Ð»Ð¸Ñ†Ðµ ÐºÐ¾Ð´ U`+`+, ÑÐ¿Ñ€Ð°Ð²Ð° 
Ð¾Ñ€Ð¸Ð³Ð¸Ð½Ð°Ð» Qt Ð¿Ñ€Ð¸Ð¼ÐµÑ€Ð°...]&]
[s0;/2 &]
[s0; [/0 Qt Ð¸ Ð»Ð¾Ð³Ð¾Ñ‚Ð¸Ð¿ Qt Ð·Ð°Ñ€ÐµÐ³Ð¸ÑÑ‚Ñ€Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð½Ñ‹Ðµ 
Ñ‚Ð¾Ñ€Ð³Ð¾Ð²Ñ‹Ðµ Ð¼Ð°Ñ€ÐºÐ¸ Trolltech Ð² ÐÐ¾Ñ€Ð²ÐµÐ³Ð¸Ð¸, Ð¡Ð¨Ð 
Ð¸ Ð´Ñ€. Ð³Ð¾ÑÑƒÐ´Ð°Ñ€ÑÑ‚Ð²Ð°Ñ….]&]
[s0;2 &]
[s0;= [2 
@@image:1778&1704
...
[s0;=2 &]
[ {{5000:5000^@7 [s0; [*2 Ultimate`+`+ Ð²ÐµÑ€ÑÐ¸Ñ]]
:: [s0; [*2 Qt Ð²ÐµÑ€ÑÐ¸Ñ]]
...
[s0;=2 ]}}&]
[s0;=2 &]
[ {{5000:5000@(255.255.200)-1 [s0; [/2 Ð§Ñ‚Ð¾Ð±Ñ‹ ÑÐ´ÐµÐ»Ð°Ñ‚ÑŒ ÑÑ€Ð°Ð²Ð½ÐµÐ½Ð¸Ðµ Ð±Ð¾Ð»ÐµÐµ ÑÐ¿Ñ€Ð°Ð²ÐµÐ´Ð»Ð¸Ð²Ñ‹
Ð¼, Ð¼Ñ‹ Ð¾Ð¿ÑƒÑÑ‚Ð¸Ð»Ð¸ Ñ‡Ð°ÑÑ‚ÑŒ Ð¿Ñ€Ð¸Ð¼ÐµÑ€Ð° U`+`+, ÑÐ¾Ð·Ð´Ð°Ð½Ð½ÑƒÑŽ 
Ñ Ð¿Ð¾Ð¼Ð¾Ñ‰ÑŒÑŽ Ñ€ÐµÐ´Ð°ÐºÑ‚Ð¾Ñ€Ð° Ð´Ð¸Ð·Ð°Ð¹Ð½Ð¾Ð² U`+`+, 
Ð¸ Ñ‡Ð°ÑÑ‚ÑŒ Ð¿Ñ€Ð¸Ð¼ÐµÑ€Ð° Qt, ÐºÐ¾Ñ‚Ð¾Ñ€Ð°Ñ Ð¼Ð¾Ð³Ð»Ð° Ð±Ñ‹ 
Ð±Ñ‹Ñ‚ÑŒ ÑÐ¾Ð·Ð´Ð°Ð½Ð° Ñ Ð¿Ð¾Ð¼Ð¾Ñ‰ÑŒÑŽ Qt Ð´Ð¸Ð·Ð°Ð¹Ð½ÐµÑ€Ð°.]]
::@2 [s0;%- ]
::^@7 [s0; [*2 Ultimate`+`+ Ð²ÐµÑ€ÑÐ¸Ñ]]
:: [s0; [*2 Qt Ð²ÐµÑ€ÑÐ¸Ñ]]
...
[s0;=2 &]
[s0;=2 &]
[s0; [2 Ð­Ñ‚Ð° ÑÑ‚Ð°Ñ‚ÑŒÑ Ð½Ð° ][^topic`:`/`/uppweb`/www`/vsqt`$en`-us^2 ÐÐ½Ð³Ð»Ð¸Ð¹Ñ
ÐºÐ¾Ð¼]]