...
[s0; [2 Abychom porovnali U`+`+ s Qt (R), rozhodli jsme se pÅ™epsat 
ukÃ¡zkovou aplikaci Qt `- `"AddressBook`". Na levÃ© stranÄ› je 
kÃ³d v U`+`+, na pravo je originÃ¡lnÃ­ pÅ™Ã­klad v Qt.]&]
[s0;/2 &]
[s0; [/0 Qt a logo Qt jsou registrovanÃ© znaÄky Trolltech v Norsku, 
SpojenÃ½ch stÃ¡tech a dalÅ¡Ã­ch zemÃ­ch.]&]
[s0;2 &]
[s0;= [2 
@@image:1778&1704
...
[s0;=2 ]}}&]
[s0;=2 &]
[ {{5000:5000@(255.255.200)-1 [s0; [/2 Aby bylo toto srovnÃ¡nÃ­ fÃ©rovÄ›jÅ¡Ã­, vynechali jsme nÃ¡sledujÃ­cÃ­ 
ÄÃ¡sti kterÃ© jsou vytvoÅ™eny pomocÃ­ Layout Designeru v U`+`+, 
a kterÃ© mohou bÃ½t obdobnÄ› vytvoÅ™eny pomocÃ­ Qt Designeru.]]
::@2 [s0;%- ]
::^@7 [s0; [*2 U`+`+ verze]]
:: [s0; [*2 Qt verze]]
