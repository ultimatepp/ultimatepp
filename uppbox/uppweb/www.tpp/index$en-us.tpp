...
&]
[s0;=l128;%% &]
[s0;l128;%% Current release: [* 2015.2 (rev ][*IRELEASET; release][* )]&]
[s0;l128;%% License: [* BSD]&]
[s0;*%% ]}}&]
[s0; &]
...
[s0;i150;O0;%% [^http`:`/`/www`.ultimatepp`.org`/forums^2 Forums]]
::l0/25r0/25t0/15b0/15R0 [s0; ]
...
::^l8/25@2-2 [s0;i150;a17;O0;%% [^http`:`/`/www`.ultimatepp`.org`/redmine`/projects`/upp^2 Project 
management (Redmine)]&]
[s0;i150;a17;O0;%% [^topic`:`/`/uppweb`/www`/svnInstall`$en`-us^2 SVN 
...
topics]&]
[s0;l160;i150;a17;O0;%% [^topic`:`/`/uppweb`/gsoc`/ideas2014`$en`-us^2 GSoC 
ideas]]
...
[s0;i150;a17;O0;%% [^https`:`/`/sourceforge`.net`/projects`/upp`/files`/upp`/2015`.2`/^2 C
urrent release][2 : ][IRELEASE;2 release]&]
