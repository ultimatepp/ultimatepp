...
[{_}%EN-US 
[s1;#b0; [R6 Current Topics]&]
[s1;#b0; &]
[s1;#b0; Introduction&]
[s0;2 &]
[s0; [2 Ultimate`+`+ project is in continuous improvement both from 
core developers and community. The interest areas cover bug fixes 
and new developments. In addition to ][^topic`:`/`/uppweb`/www`/gsoc`$en`-us^2 our 
Google Summer of Code page][2 , here we show some of the areas 
...
[s1; New developments&]
[s0;#2 &]
[s0;# [* U`+`+ port to OSX and mobile devices]&]
[s0;#* &]
[s0;# [2 Now Ultimate`+`+ works nicely in GNU/Linux and Windows. However 
there is an important number of people using other systems and 
...
[s0;# [2 No strong efforts have begun yet. If you want to do it seriously 
we would be happy to hear you in the ][^http`:`/`/www`.ultimatepp`.org`/forum`/^2 F
orum][2 .]&]
[s0;#2 &]
[s0;#2 &]
[s0;# [* Serial devices]&]
