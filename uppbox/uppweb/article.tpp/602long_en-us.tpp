topic "Ultimate++ 602 was released. Ultimate++ is a radical and innovative C++ platform whose number one priority is programmer productivity. In this respect, U++ competes with popular scripting languages while preserving C/C++ runtime characteristics.";
...
[{_}%EN-US 
[s0; Ultimate`+`+ 602 was released. Ultimate`+`+ is a radical and 
innovative C`+`+ platform whose number one priority is programmer 
productivity. In this respect, U`+`+ competes with popular scripting 
...
in the file (no C`+`+ parsing inteligence)&]
