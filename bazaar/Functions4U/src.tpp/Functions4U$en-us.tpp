...
tring]_`&[*@3 fileDll])&]
[s2; Loads a .dll in [%-*@3 fileDll].&]
[s3; &]
[s4;%- &]
[s5;:Dll`:`:GetFunction`(const String`&`):%- [@(0.0.255) void]_`*[* GetFunction]([@(0.0.255) c
onst]_[_^String^ String]_`&[*@3 functionName])&]
[s2; Gets a pointer to [%-*@3 functionName] dll function .&]
[s3; &]
[s0; &]
[s0; For example, considering that in `"adsapi32.dll`" there is a 
function called `"GetDevice`":&]
[s0; &]
[s0; [C+75 -|Dll adsapi32;]&]
...
[s0; [C+75 -|-|throw Exc(Format(t`_(`"Function %s does not found in dll`"), 
`"GetDevice`"));]&]
