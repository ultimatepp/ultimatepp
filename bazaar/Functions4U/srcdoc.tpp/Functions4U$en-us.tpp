...
[s4; &]
[s0;:Replace`(String`,String`,String`):%- [_^String^ String]_[* Replace]([_^String^ String]_
...
[s3; &]
[s4; &]
[s0;:Replace`(String`,char`,char`):%- [_^String^ String]_[* Replace]([_^String^ String]_[*@3 s
tr], [@(0.0.255) char]_[*@3 find], [@(0.0.255) char]_[*@3 replace]) [*@6 DEPRECATED]&]
[s2; Returns the resulting String obtained by replacing in [%-*@3 str] 
