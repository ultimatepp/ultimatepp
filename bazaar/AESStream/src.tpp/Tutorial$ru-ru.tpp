...
при помощи gcc/MSYS.&]
[s0;i150;O0; [- Совместное использование пакета 
с пакетом Web/SSL оставляет неиспользованные 
блоки памяти после закрытия приложения 
(блоки остаются в пакете Web/SSL).]&]
[s0; &]
