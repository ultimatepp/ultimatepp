...
[s0; [* In Linux]&]
[s0;2 &]
[s0; [2 Install ffmpeg `"`-dev`" packages:]&]
...
[s0;2 &]
[s0; [2 Copy the downloaded folders in upp folder. You will get a folder 
structure like this:]&]
[s0; [2 drive:`\upp`\plugin`_LGPL`\ffmpeg]&]
...
[s0; [2 drive:`\upp`\plugin`_LGPL`\ffmpeg`\include]]
:: [s0; [2 drive:`\upp`\plugin`_LGPL`\SDL`\lib]&]
[s0; [2 drive:`\upp`\plugin`_LGPL`\ffmpeg`\lib]]}}&]
[s0;2 &]
...
:: [s0;= [2 INCLUDE directories]]
:: [s0; [2 MSC9]]
::|1 [s0; [2 drive:`\upp`\plugin`_LGPL`\ffmpeg`\include`_msc]]
:: [s0; [2 MSC10]]
:: [s0;%- ]}}&]
[s0;2 &]
[s0;2 &]
