...
&]
[s5;:EditText`(String`&`,const char`*`,const char`*`,int`):%- [@(0.0.255) bool]_[* EditTe
xt]([_^String^ String][@(0.0.255) `&]_[*@3 s], [@(0.0.255) const]_[@(0.0.255) char]_`*[*@3 ti
tle], [@(0.0.255) const]_[@(0.0.255) char]_`*[*@3 label], [@(0.0.255) int]_[*@3 maxlen]_`=_
[@3 0])&]
...
[@(0.0.255) int]_(`*[*@3 filter])([@(0.0.255) int]), [@(0.0.255) int]_[*@3 maxlen]_`=_[@3 0])
&]
[s5;:EditText`(WString`&`,const char`*`,const char`*`,int`):%- [@(0.0.255) bool]_[* EditT
ext]([_^WString^ WString][@(0.0.255) `&]_[*@3 s], [@(0.0.255) const]_[@(0.0.255) char]_`*[*@3 t
itle], [@(0.0.255) const]_[@(0.0.255) char]_`*[*@3 label], [@(0.0.255) int]_[*@3 maxlen]_`=
_[@3 0])&]
[s2; Prompts user to edit a single text value.&]
[s3; &]
[s4; &]
[s5;:EditNumber`(int`&`,const char`*`,const char`*`,int`,int`,bool`):%- [@(0.0.255) boo
l]_[* EditNumber]([@(0.0.255) int`&]_[*@3 n], [@(0.0.255) const]_[@(0.0.255) char]_`*[*@3 tit
le], [@(0.0.255) const]_[@(0.0.255) char]_`*[*@3 label], [@(0.0.255) int]_[*@3 min]_`=_INT`_
MIN, [@(0.0.255) int]_[*@3 max]_`=_INT`_MAX, [@(0.0.255) bool]_[*@3 notnull]_`=_[@(0.0.255) f
alse])&]
