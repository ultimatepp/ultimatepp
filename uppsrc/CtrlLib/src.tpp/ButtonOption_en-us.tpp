...
[s3; &]
[s5;:ButtonOption`:`:SetImage`(const Image`&`):%- [_^topic`:`/`/CtrlLib`/src`/ButtonOption`_en`-us`#ButtonOption`:`:class^ B
uttonOption][@(0.0.255) `&]_[* SetImage]([@(0.0.255) const]_[_^topic`:`/`/Draw`/src`/Image`_en`-us`#Image`:`:class^ I
mage][@(0.0.255) `&]_[*@3 img])&]
[s2; Sets the image [%-*C@3 img] to be displayed in ButtonOption. Returns 
`*this.&]
[s3; &]
[s4;%- &]
[s5;:ButtonOption`:`:SetImage`(const Image`&`,const Image`&`):%- [_^topic`:`/`/CtrlLib`/src`/ButtonOption`_en`-us`#ButtonOption`:`:class^ B
uttonOption][@(0.0.255) `&]_[* SetImage]([@(0.0.255) const]_[_^topic`:`/`/Draw`/src`/Image`_en`-us`#Image`:`:class^ I
mage][@(0.0.255) `&]_[*@3 m], [@(0.0.255) const]_[_^topic`:`/`/Draw`/src`/Image`_en`-us`#Image`:`:class^ I
mage][@(0.0.255) `&]_[*@3 m1])&]
...
[s3; &]
[s4;%- &]
[s5;:ButtonOption`:`:SetLabel`(const String`&`):%- [_^topic`:`/`/CtrlLib`/src`/ButtonOption`_en`-us`#ButtonOption`:`:class^ B
uttonOption][@(0.0.255) `&]_[* SetLabel]([@(0.0.255) const]_[_^topic`:`/`/Core`/src`/String`_en`-us`#String`:`:class^ S
tring][@(0.0.255) `&]_[*@3 text])&]
[s2; Sets the label of the button to [%-*@3 text].&]
[s3; &]
[s4;%- &]
[s5;:ButtonOption`:`:GetLabel`(`)const:%- [_^topic`:`/`/Core`/src`/String`_en`-us`#String`:`:class^ S
tring]_[* GetLabel]()_[@(0.0.255) const]&]
[s2; Returns the label of the button.&]
[s3;%- &]
[s4;%- &]
[s5;:ButtonOption`:`:StyleDefault`(`):%- [@(0.0.255) static] [@(0.0.255) const]_[_^topic`:`/`/CtrlLib`/src`/ButtonOption`_en`-us`#ButtonOption`:`:Style`:`:struct^ S
tyle][@(0.0.255) `&]_[* StyleDefault]()&]
[s2; Returns the default style used to draw a `"normal`" ButtonOption.&]
[s0; &]
[s4;%- &]
[s5;:ButtonOption`:`:StyleFlat`(`):%- [@(0.0.255) static] [@(0.0.255) const]_[_^topic`:`/`/CtrlLib`/src`/ButtonOption`_en`-us`#ButtonOption`:`:Style`:`:struct^ S
tyle][@(0.0.255) `&]_[* StyleFlat]()&]
[s2; Returns the default style used to draw a `"flat`" ButtonOption.&]
[s3;%- &]
[s4;%- &]
[s5;:ButtonOption`:`:SetStyle`(const ButtonOption`:`:Style`&`):%- [_^topic`:`/`/CtrlLib`/src`/ButtonOption`_en`-us`#ButtonOption`:`:class^ B
uttonOption][@(0.0.255) `&]_[* SetStyle]([@(0.0.255) const]_[_^topic`:`/`/CtrlLib`/src`/ButtonOption`_en`-us`#ButtonOption`:`:Style`:`:struct^ S
tyle][@(0.0.255) `&]_[*@3 s])&]
[s2; Sets the style of the button to [%-*@3 s]. Returns `*this for 
chaining.&]
[s3; &]
[s4;%- &]
[s5;:ButtonOption`:`:AutoStyle`(`):%- [_^topic`:`/`/CtrlLib`/src`/ButtonOption`_en`-us`#ButtonOption`:`:class^ B
uttonOption][@(0.0.255) `&]_[* AutoStyle]()&]
