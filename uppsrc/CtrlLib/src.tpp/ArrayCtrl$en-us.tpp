...
[s3; &]
[s4;%- &]
[s5;:ArrayCtrl`:`:CreateCtrl`(int`,int`,bool`):%- [@(0.0.255) template]_<[@(0.0.255) clas
s]_[*@4 T]>_[*@4 T][@(0.0.255) `&]_[* CreateCtrl]([@(0.0.255) int]_[*@3 i], 
...
If [%-*@3 value] is true, then the Ctrl represents the value of 
the cell, otherwise it is independent of it.&]
[s3; &]
[s4;%- &]
