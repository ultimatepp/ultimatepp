...
parameter. Return empty String if resource not found..&]
[s4;%% &]
[s1; &]
...
specified in SVG and uses computed bounding box. It is then placed 
into [%-*@3 sz], preserving aspect ratio. Use [%-*@3 resloader] to 
provide resources.&]
[s4;%% &]
[s0;%% ]]