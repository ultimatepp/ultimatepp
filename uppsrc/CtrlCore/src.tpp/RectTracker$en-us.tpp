...
[s3;%% &]
[s4; &]
[s5;:RectTracker`:`:Pattern`(uint64`): [_^RectTracker^ RectTracker][@(0.0.255) `&]_[* Patte
rn]([_^uint64^ uint64]_[*@3 p])&]
[s2;%% Sets the pattern of lines.&]
[s3;%% &]
[s4; &]
[s5;:RectTracker`:`:Dashed`(`): [_^RectTracker^ RectTracker][@(0.0.255) `&]_[* Dashed]()&]
[s2;%% Sets dashed pattern.&]
[s3;%% &]
[s4; &]
[s5;:RectTracker`:`:Solid`(`): [_^RectTracker^ RectTracker][@(0.0.255) `&]_[* Solid]()&]
[s2;%% Sets solid pattern.&]
[s3;%% &]
[s4; &]
