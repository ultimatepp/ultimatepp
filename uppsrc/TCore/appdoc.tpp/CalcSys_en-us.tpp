...
"[s14;:Calc`$Cnull0: [%00-00 null ][%00-00S ®][%00-00  empty value]&][s0; Null value. "
"During calculation the null value usually propagates from the subexpression: if any "
"of the operands or function parameters contains the null value, the result of the "
"operation or of the function is null as well. A few exceptions to this rule include "
"special operators [* ?:], [* `|`|], [* `&`&], [* `=`=], [* !`=] and also the functions "
"[* is_number], [* is_text], [* is_date], and_[* is_null], which process null values "
"differ")
TOPIC_TEXT(
"ently.&][s0; &][s0; [* Example]: 10 `+ null `= null&][s14;:Calc`$CnvlVV: [%00-00 "
"nvl (any data type, any data type) ][%00-00S ®][%00-00  any data type]&][s0; This "
"function returns its first parameter if it is not [* null]. If the first parameter "
"is [* null] the function returns its second parameter.&][s0; &][s0; [* Example]: "
"nvl(`\"first`\", `\"second`\") `= `\"first`\", nvl(`\"`\", `\"second`\") `= `\"second`\"&][s0; "
"&][s0; ]")
