...
{
	bar.Add(file.IsCursor(), "Add..", [this] { AddLang(); });
	bar.Add(lang.IsCursor(), "Remove", [this] { RemoveLang(); });
	bar.Separator();
	bar.Add(file.IsCursor(), "Add to all..", [this] { AddLangAll(); });
	bar.Add(lang.IsCursor(), "Remove from all..", [this] { RemoveLangAll(); });
}
