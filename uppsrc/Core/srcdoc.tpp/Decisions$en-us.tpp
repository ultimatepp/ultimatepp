topic "Design decisions and tradeoffs";[2 $$0,0#00000000000000000000000000000000:Default]
...
2[` 31 ]`- 1 `= [%00-00 2,147,483,647.]&]
[s0;i150;b33;O0; GUI is single threaded. That does not mean you cannot 
do multi`-threaded GUI apps `- just use only one thread to perform 
GUI and communicate with others via timer queue (We guess this 
method is far safer anyway).&]
