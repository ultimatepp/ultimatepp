...
[{_} 
[ {{10000@(113.42.0) [s0;%% [*@7;4 SecureRandomGenerator]]}}&]
[s2; &]
[s1;:Upp`:`:SecureRandomGenerator: [@(0.0.255) class ][*3 SecureRandomGenerator][3  
][@(0.0.255)3 :][3  ][*@3 NoCopy]&]
[s2;%% This class provides a cryptographically secure random number 
and nonce generator compliant with NIST SP 800`-38D, tailored 
for high`-security applications that demand guaranteed uniqueness 
...
[s2;%% &]
[s2; Note: This class is intended for internal use in high`-assurance 
cryptographic protocols. Always use the provided helpers for 
nonce generation instead of manually creating random data.&]
[s0;R+93 &]
[ {{10000F(128)G(128)@1 [s0;%% [* Public Method List]]}}&]
[s3; &]
[s5;:Upp`:`:SecureRandomGenerator`:`:Instance`(`): [@(0.0.255) static] 
SecureRandomGenerator[@(0.0.255) `&] [* Instance]()&]
[s2;%% Returns the singleton instance of the generator.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:SecureRandomGenerator`:`:Generate`(int`): String [* Generate]([@(0.0.255) int
] [*@3 n])&]
[s2;%% Generates [%-*@3 n] bytes of cryptographically secure random 
data. Suitable for general`-purpose randomness, such as key generation 
or entropy pools. Returns a void string on failure.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:SecureRandomGenerator`:`:GenerateNonce`(int`): String 
[* GenerateNonce]([@(0.0.255) int] [*@3 n])&]
[s2;%% Generates a secure, process`-unique nonce of length [%-*@3 n] 
bytes. Nonces are guaranteed to be unique per invocation, process, 
and fork (on POSIX systems). The minimum length is 12 bytes. 
Returns a void string on failure.&]
[s3; &]
[ {{10000F(128)G(128)@1 [s0;%% [* Function List]]}}&]
[s3; &]
[s5;:Upp`:`:SecureRandom`(int`): String [* SecureRandom]([@(0.0.255) int] 
[*@3 n])&]
[s2;%% Same as SecureRandomGenerator`::Instance().Generate(n). Generates 
[%-*@3 n] random bytes. Returns a void string on failure.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:SecureNonce`(int`): String [* SecureNonce]([@(0.0.255) int] 
[*@3 n])&]
[s2;%% Same as SecureRandomGenerator`::Instance().GenerateNonce(n). 
Generates a secure nonce of [%-*@3 n] bytes. Returns a void string 
on failure.&]
[s3; &]
