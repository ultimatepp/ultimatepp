...
String HttpStatus::ToString(int status) {
	switch (status) {
		...
		case NON_AUTHORITATIVE_INFO: return "Non Authoritative Info";
		...
		case PROXY_AUTH_REQUIRED: return "Proxy Auth Required";
		case REQUEST_TIEMOUT: return "Request Timeout";
		...
		case REQUEST_RANGE_NOT_SATISFIABLE: return "Request Range Not Satisfiable";
