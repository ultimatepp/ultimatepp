...
enum {
	XMLRPC_SERVER_JSON_ERROR = -32700,    // Parse error
	XMLRPC_SERVER_JSON_REQUEST_ERROR = -32600, // Invalid Request
	XMLRPC_UNKNOWN_METHOD_ERROR = -32601, // Method not found
	XMLRPC_SERVER_PARAM_ERROR = -32602, // Invalid params
	XMLRPC_SERVER_PROCESSING_ERROR = -32000, // Server error
	...
	XMLRPC_CLIENT_JSON_ERROR,
	XMLRPC_CLIENT_RESPONSE_ERROR,
};
