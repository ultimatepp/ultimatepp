...
[s1;:One`:`:class:%- [@(0.0.255) class]_[* One]_:_[@(0.0.255) private]_[*@3 MoveableAndDeepCop
yOption][@(0.0.255) <]_[* One][@(0.0.255) <][*@4 T][@(0.0.255) >]_>_&]
...
[s2; Requires T to have deep copy constructor or optional deep copy 
constructor.&]
[s3; &]
[s4;%- &]
