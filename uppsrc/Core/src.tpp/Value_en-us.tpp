...
[s5;:Value`:`:operator float`(`)const:%- [* operator_float()]_[@(0.0.255) const]&]
...
[s5;:Value`:`:operator size`_t`(`)const:%- [* operator_size`_t]()_[@(0.0.255) const]&]
...
[s5;:Value`:`:Value`(size`_t`):%- [* Value](size`_t_[@3 s])&]
[s5;:Value`:`:Value`(float`):%- [* Value]([@(0.0.255) float]_[*@3 d])&]
