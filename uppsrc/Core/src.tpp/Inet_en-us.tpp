...
String[@(0.0.255) `&] [*@3 s])&]
[s2;%% Similar to UrlEncode, but does not encode `'/`' until the 
first `'?`' which is not encoded as well. After that, it encodes 
`'/`' and `'?`' too. E.g. [C UrlEncodePath(`"//this/is/test?/?`")] 
returns [C@5 `"//this/is/test?%2F%3F`"].&]
[s3; &]
[s4; &]
