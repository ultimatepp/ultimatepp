...
exists. returns true if the listen is successful. Note that [%-*@3 reuse] 
option is not supported on Windows and if specified the listen 
will fail and set the socket into error state.&]
[s3; &]
[s4; &]
