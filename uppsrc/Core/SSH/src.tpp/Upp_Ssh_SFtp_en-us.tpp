...
nt]_[*@3 ms])&]
[s2;%% Sets timeout value in miliseconds. Returns `*this for method 
chaining.&]
[s3;%% &]
[s4; &]
...
The default chunk size is 64K Returns `*this for method chaining.&]
[s3;%% &]
[s4; &]
...
]_[* OpenRead]([@(0.0.255) const]_[_^Upp`:`:String^ String][@(0.0.255) `&]_[*@3 path])&]
...
e]_[* OpenWrite]([@(0.0.255) const]_[_^Upp`:`:String^ String][@(0.0.255) `&]_[*@3 path])&]
...
[s2;%% Closes the file [%-*@3 handle]. Return true on success. File 
handles obtained with Open() or OpenDir() methods must be released 
using this method when finished.&]
[s3;%% &]
[s4; &]
...
[s3;%% &]
[s4; &]
[s5;:Upp`:`:SFtp`:`:OpenDir`(const Upp`:`:String`&`): [_^Upp`:`:SFtpHandle^ SFtpHandle]_
[* OpenDir]([@(0.0.255) const]_[_^Upp`:`:String^ String][@(0.0.255) `&]_[*@3 path])&]
...
[s3; &]
[s4; &]
[s5;:Upp`:`:SFtp`:`:MakeLink`(const Upp`:`:String`&`,Upp`:`:String`&`): [@(0.0.255) boo
l]_[* MakeLink]([@(0.0.255) const]_[_^Upp`:`:String^ String][@(0.0.255) `&]_[*@3 orig], 
...
[s3;%% &]
[s4; &]
[s5;:Upp`:`:SFtp`:`:GetAttrs`(Upp`:`:SFtpHandle`,Upp`:`:SFtpAttrs`&`): [@(0.0.255) bool
]_[* GetAttrs]([_^Upp`:`:SFtpHandle^ SFtpHandle]_[*@3 handle], [_^Upp`:`:SFtpAttrs^ SFtpA
ttrs][@(0.0.255) `&]_[*@3 attrs])&]
