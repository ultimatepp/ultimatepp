...
[s0; &]
[s0; Public Field detail&]
[s3;K:`:`:Size`_`:`:cx:%- [@4 T]_cx&]
[s2; the horizontal dimension&]
[s0; &]
[s3;K:`:`:Size`_`:`:cy:%- [@4 T]_cy&]
...
[s4; &]
[s3;K:`:`:Size`_`:`:IsEmpty`(`)const: bool_[@0 IsEmpty]()_const&]
...
[s4; &]
[s3;K:`:`:Size`_`:`:IsNullInstance`(`)const: bool_[@0 IsNullInstance]()_const&]
[s2; Verifies if size is [* Null].&]
[s4; &]
[s3;K:`:`:Size`_`:`:GetHashValue`(`)const: unsigned_[@0 GetHashValue]()_const&]
...
[s4; &]
[s3;K:`:`:Size`_`:`:operator`:`:Value`(`)const: operator_[@0 Value]()_const&]
