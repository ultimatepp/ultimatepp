...
[*@3 id], [@(0.0.255) void]_(`*[*@3 handler])([_^Http^ Http][@(0.0.255) `&]), 
...
[s2; Calls Renderer`::operator([%-*@3 row`_sel]) to set the values of 
shared space variables based on column`-name/value pairs of single 
row fetched from database using [%-*@3 row`_sel]. Returns `*this.&]
[s3; &]
[s4; &]
...
[s3; &]
[s4; &]
[s5;:Http`:`:Render`(const char`*`,const String`&`):%- [_^Http^ Http][@(0.0.255) `&]_[* Ren
der]([@(0.0.255) const]_[@(0.0.255) char]_`*[*@3 id], [@(0.0.255) const]_[_^String^ String][@(0.0.255) `&
]_[*@3 template`_name])&]
[s2; Calls Renderer`::Render([%-*@3 id], [%-*@3 template`_name]) to render 
witz template as RawHtmlText into shared space variable [%-*@3 id]. 
Returns `*this.&]
[s3; &]
[s4; &]
...
[s3; &]
[s4;%- &]
[s5;:Http`:`:GetHandlerId`(`)const:%- [_^String^ String]_[* GetHandlerId]()_[@(0.0.255) con
st]&]
...
[s2; Returns the shared space variable [%-*@3 id, ]void Value if missing.&]
[s3; &]
[s4; &]
...
[s2; Sets the response content to [%-*@3 data] converted to text. No 
html escaping is performed. Returns `*this.&]
[s3; &]
[s4; &]
...
[s2; Sets the session value [%-*@3 id] to [%-*@3 value], also sets shared 
variable space to the same value. [%-*@3 id] must start with `'.`'. 
Session variables are preserved for session across HTTP requests 
(using session cookies). Returns `*this.&]
[s3; &]
[s4; &]
[s5;:Http`:`:NewSessionId`(`):%- [_^Http^ Http][@(0.0.255) `&]_[* NewSessionId]()&]
[s2; Sets the new session id, effectively changing the session cookie 
value and storage for current session. Returns `*this.&]
[s3; &]
[s4; &]
[s5;:Http`:`:NewIdentity`(`):%- [_^Http^ Http][@(0.0.255) `&]_[* NewIdentity]()&]
[s2; Sets the new CSRF prevention identity. It might be a good idea 
to call this function after login. Returns `*this.&]
[s3; &]
[s4; &]
...
[@(0.0.255) int]_[*@3 code], [@(0.0.255) const]_[_^String^ String][@(0.0.255) `&]_[*@3 ctext])
&]
[s2; Sets the HTTP response [%-*@3 code] and reason [%-*@3 ctext]. Returns 
`*this.&]
[s3; &]
[s4; &]
...
[s2; Sets the response to be redirection. [%-*@3 url][%-  sets the Location: 
header of response, ][%-*@3 code][%-  the response code.] Returns 
`*this.&]
[s3; &]
[s4; &]
