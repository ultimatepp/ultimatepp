#ifndef __Plugin_SQLCipher__
#define __Plugin_SQLCipher__
...
bool SQLCipherPerformScript(const String& text,
#ifdef NOAPPSQL
...
class SQLCipherSession : public SqlSession {
public:
	virtual bool           IsOpen() const               { return NULL != db; }
	virtual RunScript      GetRunScript() const         { return &SQLCipherPerformScript; }
...
private:
	friend class SQLCipherConnection;
